      ...
      <div class="row">
        <div class="col-md-12">
          <form class="">
			...
			<label>Nome Comune</label> <input type="text" class="form-control" placeholder="Enter email" name="nome_comune">
			<label>Provincia Comune</label> <input type="text" class="form-control" placeholder="Enter email" name="provincia_comune">
			<label>Regione Comune</label> <input type="text" class="form-control" placeholder="Enter email" name="regione_comune">
			<label>Stato Comune</label> <input type="text" class="form-control" placeholder="Enter email" name="stato_comune"></div>
