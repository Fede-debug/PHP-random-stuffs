        ...
        <div class="col-md-12">
          <form class="" method="post" action="salva_comune.php">
			...
			<div class="form-group"> 
				...
				?>
				<input type="text" name="provincia" class="form-control <?=$messaggio ? "is-invalid" : ""?>" value="<?=array_key_exists('provincia', $old) ? $old['provincia'] : $comune->getProvincia() ?>" placeholder="Inserire la provincia">
				<div class="invalid-feedback">
					<?=$messaggio ? $messaggio : ""?>
				</div>
			</div>
			...
			<a class="btn btn-danger" href="comuni.php">Annulla</a>
