...
class PersonaController {
	...
	public static function eliminaPersona(Persona $persona)  {
		
		$connessione = new PDO("mysql:host=localhost;dbname=anagrafiche", "root", null);
		$statement = $connessione->query("DELETE FROM persone WHERE id=:id");
		
			
			$statement = $connessione->prepare($sql);
			$statement->bindValue(':id', $persona->getId() , PDO::PARAM_INT);
			$statement->execute();
