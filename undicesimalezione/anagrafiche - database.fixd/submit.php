...
else if(strlen(trim($_POST['codice_fiscale']))!==16) {    //controllo anche che ilcodice fiscale sia di 16 caratteri
	$errori['codice_fiscale'] = "Il codice fiscale richiede 16 caratteri esatti";           //(se è più lungo non viene saltato nel database perché 
}                                                                                 //l'attributo è VARCHAR(16)
